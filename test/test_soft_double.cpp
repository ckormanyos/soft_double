...
auto test_soft_double() -> bool
{
  ...
  constexpr auto test_to_f32_n          = static_cast<std::uint32_t>(UINT32_C(50000000));
  constexpr auto test_frexp_ldexp_ops_n = static_cast<std::uint32_t>(UINT32_C(20000000));
  constexpr auto test_floor_ceil_n      = static_cast<std::uint32_t>(UINT32_C(50000000));
  #else
  constexpr auto test_to_f32_n          = static_cast<std::uint32_t>(UINT32_C(5000000));
  constexpr auto test_frexp_ldexp_ops_n = static_cast<std::uint32_t>(UINT32_C(2000000));
  constexpr auto test_floor_ceil_n      = static_cast<std::uint32_t>(UINT32_C(5000000));
  #endif
