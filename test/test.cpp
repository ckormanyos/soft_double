...
// g++ -finline-functions -finline-limit=32 -fno-exceptions -fno-rtti -m64 -O3 -Wall -Wextra -pedantic -std=c++11 -I. examples/example001_roots_sqrt.cpp examples/example004_bessel_recur.cpp examples/example007_catalan_series.cpp test/test.cpp test/test_soft_double.cpp test/test_soft_double_examples.cpp test/test_soft_double_with_decwide_t_100k_digit_pi.cpp -o soft_double.exe
