...
///////////////////////////////////////////////////////////////////
  ...
  {
    return ::math::softfloat::float64_t(  (uint64_t) (::math::softfloat::float64_t::get_value(a) & ~(uint64_t) (0x7FFULL << 52U))
                                 | (uint64_t) (((uint64_t) ((int_fast16_t) ((int_fast16_t) ((uint_fast16_t) (::math::softfloat::float64_t::get_value(a) >> 52U) & 0x7FFU) - 1))) << 52U),
